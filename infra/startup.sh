...
server {
    ...
    # Seller dashboard
    location /seller/ { proxy_pass http://127.0.0.1:3013/; proxy_set_header Host $host; proxy_set_header X-Forwarded-Proto $scheme; }
    location = /seller { return 301 /seller/; }
    location /seller/_next/ { proxy_pass http://127.0.0.1:3013/_next/; proxy_set_header Host $host; }

    # Admin panel
    location /admin/ { proxy_pass http://127.0.0.1:3014/; proxy_set_header Host $host; proxy_set_header X-Forwarded-Proto $scheme; }
